...
This document defines the standard that every repository in the TV-SALES-HOME GitHub organization must follow.
...
* @TV-SALES-HOME/engineering

# CI/CD changes require senior review
.github/workflows/ @TV-SALES-HOME/senior-engineers

# Security files require security team review
SECURITY.md @TV-SALES-HOME/security
docs/security.md @TV-SALES-HOME/security
```
...
1. Use `demo_repository` as the template
...
*This standard is maintained in `demo_repository/docs/repository-standard.md`.*
